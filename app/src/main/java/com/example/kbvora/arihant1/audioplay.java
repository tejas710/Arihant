...
public class audioplay extends ActionBarActivity {
    ...
    class jinal extends  AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(audioplay.this,"downloading", Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(audioplay.this, "Downloading Complete", Toast.LENGTH_LONG).show();
        ...
        protected String doInBackground(String... params) {
            ...
            {
                Toast.makeText(audioplay.this, ex.toString(), Toast.LENGTH_LONG).show();
            }
            return null;
        }
    }
    class Player extends AsyncTask<String, Void, Boolean> {
        ...
        public Player() {
            progress = new ProgressDialog(audioplay.this);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1=(TextView)findViewById(R.id.MarqueeText);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_audioplay, menu);
        return true;
    }
